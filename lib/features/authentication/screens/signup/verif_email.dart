      ...
      body:  SingleChildScrollView(
        ...
        Padding(
          ...
          child: Column(
            children: [
              //Image
              Image(image: AssetImage(FImages.verifyEmailImage), width: FHelperFunctions.screenWidth() * 0.6,),
              ...
              SizedBox(width: double.infinity, child: ElevatedButton(onPressed: () {}, child: const Text(FTexts.fcontinue))),
              const SizedBox(height: FSizes.defaultBtwItems),

              SizedBox(width: double.infinity, child: TextButton(onPressed: () {}, child: const Text(FTexts.resendEmail))),
            ],
          ),
